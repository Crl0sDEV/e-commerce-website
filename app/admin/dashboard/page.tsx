  ...
  return (
    <main className="max-w-7xl mx-auto px-4 py-6 md:py-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        {/* Mobile: Full width grid, Desktop: Flex row */}
        <div className="w-full md:w-auto grid grid-cols-1 sm:grid-cols-3 gap-2 sm:flex">
            <Link 
              href="/admin/coupons" 
              className="bg-white border border-gray-300 px-4 py-2.5 rounded-lg hover:bg-gray-50 text-sm font-medium text-center flex items-center justify-center"
            >
              Promo Codes
            </Link>
            <Link 
            ...
            <Link 
              href="/admin/products" 
              className="bg-black text-white px-4 py-2.5 rounded-lg hover:bg-gray-800 text-sm font-bold text-center flex items-center justify-center"
            >
              Manage Inventory
            </Link>
        </div>
        ...
        <div className={`p-6 rounded-xl border shadow-sm ${stats.lowStockCount > 0 ? 'bg-red-50 border-red-200' : 'bg-white border-gray-200'}`}>
          <div className="flex justify-between items-start mb-4">
            <div>
              ...
              <h3 className={`text-2xl md:text-3xl font-bold mt-1 ${stats.lowStockCount > 0 ? 'text-red-700' : 'text-gray-900'}`}>
                {stats.lowStockCount}
              </h3>
            </div>

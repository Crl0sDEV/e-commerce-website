    ...
    try {
      ...
      for (const item of cart) {
        ...
        if (curr) {
          await supabase
            .from("products")
            .update({ stock: Math.max(0, curr.stock - item.quantity) })
            .eq("id", item.id);
        }
      }
    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 py-10 animate-in fade-in zoom-in duration-300">
        ...
        <p className="text-gray-500 max-w-md mb-6">
          Thank you, {formData.name}! We have received your order via{" "}
          {paymentMethod}.
        </p>
        {orderId && (
          ...
          <form onSubmit={handleCheckout} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg p-3 outline-none focus:ring-2 focus:ring-black transition"
                value={formData.name}
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-lg p-3 outline-none focus:ring-2 focus:ring-black transition resize-none"
            ...
            <div className="pt-4 border-t border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                <div
                  ...
                  className={`border rounded-xl p-4 cursor-pointer flex flex-col items-center justify-center transition ${
                    paymentMethod === "COD"
            ...
            >
              {loading ? (
                ...
                `Place Order (${paymentMethod}) • ₱${totalAmount.toFixed(2)}`
              )}
            </button>
          </form>
        </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={
                  isValidatingCoupon || appliedCoupon !== null || !couponCode
                }
            ...
            {discountAmount > 0 && (
              <div className="flex justify-between text-green-600 font-medium animate-in fade-in">
                <span className="flex items-center gap-1">
                  <Tag size={14} /> Discount ({appliedCoupon})
                </span>
